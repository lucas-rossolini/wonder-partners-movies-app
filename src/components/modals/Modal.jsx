          ...
          <>
            <div className="min-h-fit block">
              ...
              <div className="flex flex-col justify-center items-center mt-36">
                ...
                <div className="mx-24 text-center mt-4 text-base">Start typing to find a Movie!</div>
                <div className="mx-24 text-center mt-2 text-xs text-LightGray">Find your movie by title</div>
              </div>
            </div>
